...
locals {
  ...
  # For an updated list of number of fault domains in a region, check here
  # https://github.com/MicrosoftDocs/azure-docs/blob/master/includes/managed-disks-common-fault-domain-region-list.md#number-of-fault-domains-per-region
  regions_with_diff_fault_domains = {
    eastus         = "3",
    eastus2        = "3",
    westus         = "3",
    centralus      = "3",
  ...
  fault_domain_count_r1 = lookup(local.regions_with_diff_fault_domains, var.azure_region_r1, "2")
  fault_domain_count_r2 = lookup(local.regions_with_diff_fault_domains, var.azure_region_r2, "2")
  fault_domain_count_r3 = lookup(local.regions_with_diff_fault_domains, var.azure_region_r3, "2")
